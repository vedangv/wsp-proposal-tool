...
from app.agents import cv_fetcher, rfp_extractor, relevant_projects_fetcher
...
async def get_job_status(
    ...
    job = cv_fetcher.get_job(job_id) or rfp_extractor.get_job(job_id) or relevant_projects_fetcher.get_job(job_id)
    if not job:
